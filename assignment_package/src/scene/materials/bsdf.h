...
// Utility functions for dealing with vectors in tangent space,
// such as when evaluating BSDFs
...
inline bool Refact(const Vector3f &wi, const Normal3f &n, float eta, Vector3f *wt)
{
